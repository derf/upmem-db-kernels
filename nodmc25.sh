...
parallel -j1 --eta --joblog ${fn}.node1.joblog --resume --header : \
	...
	::: numa_mem 1 \
	::: numa_cores 8-15 \
	::: n_elements $((1024*1024)) $((1024*1024*2)) $((1024*1024*4)) $((1024*1024*8)) $((1024*1024*32)) $((1024*1024*64)) $((1024*1024*128)) $((1024*1024*256)) $((1024*1024*512)) $((1024*1024*1024)) $((1024*1024*1024*2)) $((1024*1024*1024*3)) $((1024*1024*1024*4)) $((1024*1024*1024*5)) $((1024*1024*1024*6)) $((1024*1024*1024*7)) \
	::: n_threads 1 2 4 6 8 \
...
parallel -j1 --eta --joblog ${fn}.node0.joblog --resume --header : \
	...
	::: numa_mem 0 \
	::: numa_cores 0-7 \
	::: n_elements $((1024*1024)) $((1024*1024*2)) $((1024*1024*4)) $((1024*1024*8)) $((1024*1024*32)) $((1024*1024*64)) $((1024*1024*128)) $((1024*1024*256)) $((1024*1024*512)) $((1024*1024*1024)) $((1024*1024*1024*2)) $((1024*1024*1024*3)) $((1024*1024*1024*4)) $((1024*1024*1024*5)) $((1024*1024*1024*6)) \
	::: n_threads 1 2 4 6 8 \
