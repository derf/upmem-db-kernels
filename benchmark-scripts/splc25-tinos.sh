...
fn=log/$(hostname)/splc25-cpu

parallel -j1 --eta --joblog ${fn}.node1.joblog --resume --header : \
	run_benchmark_cpu numa_mem={numa_mem} numa_cores={numa_cores} n_elements={n_elements} n_threads={n_threads} operation={operation} n_operations={n_operations} \
	::: numa_mem 1 \
	::: numa_cores 8-15 \
...
for sdk in 2023.2.0 2024.1.0 2024.2.0 2025.1.0; do
	...
	fn=log/$(hostname)/splc25-upmem-${sdk}
